'use strict';
// National Bank of Ukraine exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbu';
...
/** Latest rate for one pair, e.g. getRate('USD', 'UAH', { apiKey }). */
